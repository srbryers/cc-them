...
Works two ways: as Claude Code sub-agents (`npx cc-them install <slug>`) or as an MCP server for any Claude client. Eight profiles ship today — engineering (Hickey, Torvalds, Carmack, Karpathy, Sid Meier) and strategy (Hormozi, Dunford, Rachitsky).
